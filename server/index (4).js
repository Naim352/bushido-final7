...
app.post('/api/auth/inscription', async (req, res) => {
  ...
  try {
    ...
    // 🔔 Notification → toi (nouveau client inscrit)
    ...
    // ✉️ Email de bienvenue → le client, avec le lien vers son compte
    sendMail(
      client.email,
...
// 🔍 Page de diagnostic temporaire — à supprimer une fois tout vérifié
